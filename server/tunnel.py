...
class TunnelManager:
    ...
    async def create_tunnel(self, service_id: str, client_id: str) -> Tunnel:
        """创建隧道"""
        tunnel = Tunnel(id=str(uuid.uuid4())[:12], service_id=service_id, client_id=client_id)
    ...
    async def forward_request(
        self, tunnel_id: str, request_id: str, method: str, params: dict, timeout: float = 30.0
    ) -> dict:
        """
        转发请求到对应节点
