...
class KeyManager:
            ...
            self._storage.save_key(
                {
                    ...
                    "duration_seconds": int(
                        (lifecycle.expires_at - lifecycle.created_at).total_seconds()
                    ),
    ...
    def register_policy(self, service_id: str, policy: dict):
        ...
        self._service_policies[service_id] = {
            "default": {"duration_seconds": duration, "max_calls": max_calls},
    ...
    def get_policy(self, service_id: str) -> dict:
        ...
        return self._service_policies.get(
            service_id, {"default": {"duration_seconds": 3600, "max_calls": 100}, "custom": {}}
        )
    ...
    def list_keys(
        self, service_id: str = None, consumer_id: str = None, active_only: bool = False
    ) -> List[dict]:
        """列出 Key"""
        result = []
