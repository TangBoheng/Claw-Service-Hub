...
try:
    ...
    from server.chat.handlers import ChatHandler
...
class HubServer:
    ...
    def __init__(self, host: str = HOST, port: int = PORT):
        ...
        self.chat_handler = ChatHandler(
            channel_mgr=self.chat_channel_mgr,
            client_websockets=self._client_websockets,
    ...
    async def _process_message(self, websocket: ServerConnection, client_id: str, raw_message: str):
        ...
        try:
            ...
            # === Chat 通讯相关 ===
                ...
                await self.chat_handler.handle_chat_message(websocket, client_id, message)

            elif msg_type == "chat_history":
                await self.chat_handler.handle_chat_history(websocket, client_id, message)
